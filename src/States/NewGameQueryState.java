...
public class NewGameQueryState extends ReversibleState {
    ...
    public static final int QUERY_X = 250;///< The x coordinate of the question
    ...
    public NewGameQueryState() {
        ...
        newGameQuery = new GUIText("ARE YOU SURE? THIS WILL DELETE YOUR PROGRESS.", QUERY_X, QUERY_Y, 75);
    }
