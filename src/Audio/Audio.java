...
public class Audio {
    ...
    public Audio(String path, boolean loop) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
        audioInputStream = AudioSystem.getAudioInputStream(Audio.class.getResource(path));
